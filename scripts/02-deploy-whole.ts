...
async function main() {
  ...
  const signer = new ethers.Wallet(process.env.SEPOLIA_PRIVATE_KEY!, ethers.provider)
  console.log(signer)
  ...
  await saleTokenFactoryDeployed.createSaleToken(SALE_TOKEN_NAME, SALE_TOKEN_SYMBOL);
